...
>Fastjson是一个Java语言编写的高性能功能完善的JSON库。它采用一种“假定有序快速匹配”的算法，把JSON Parse的性能提升到极致，是目前Java语言中最快的JSON库。Fastjson接口简单易用，已经被广泛使用在缓存序列化、协议交互、Web输出、Android客户端等多种应用场景。
 ...
 ####本章目标
  ...
  >**2.添加FastJson配置类**
  在项目config目录下添加FastJsonConfiguration类如下图：
  ![添加FastJsonConfiguration类](./doc/img/004_add_fastJson/add_fastJson_config_class.png)
  ```java
...
>**3.添加UserController进行数据转换结果测试**
见下图：
![添加UserController](./doc/img/004_add_fastJson/add_usercontrl_test_fastJson.png)
```java
...
![run_project_1](./doc/img/004_add_fastJson/add_fastJson_run_project.png)
![run_project_2](./doc/img/004_add_fastJson/add_fastJson_run_project_second.png)

>**5.访问项目产看结果**

通过浏览器访问本地的项目如图：

![查看项目运行结果](./doc/img/004_add_fastJson/test_result.png)


浏览其中显示如上结果，就说明我们项目中的FastJson配置成功。
